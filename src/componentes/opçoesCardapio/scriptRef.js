    ...
    <table class="centered">
        <thead>
            <ul class="pagination">
                ...
                <li class="waves-effect"><a href="#!"> DD/MM/AAAA</a></li>
                <li class="waves-effect"><a href="#!"><i class="material-icons">chevron_right</i></a></li>
            </ul>
            <tr v-for="col in colunaRefeições">
                <th>{{col.nome}}</th>
                <th>{{col.hora}}</th>
                <th></th>
            </tr>
        ...
        <tbody>
            <tr v-for="refeição in refeições">
                <td>{{refeição.tipo}}</td>
                <td>{{refeição.horário}}</td>
...
Vue.component('cmp-not', {
    template: `
    <div>
    <ul class="collection">
        <a href="breakfast.html" class="itemNotification">
            <li class="collection-item avatar">
                <img v-bind:src="notificações[0].img" class="circle">
                <span class="title">{{notificações[0].titulo}}</span>
                <p>
                    {{notificações[0].conteúdo}}
                </p>
                <a href="#!" class="secondary-content"><i class="material-icons"></i></a>
            </li>
        </a>
        <a href="lunch.html" class="itemNotification">
            <li class="collection-item avatar">
                <img v-bind:src="notificações[1].img" class="circle">
                <span class="title">{{notificações[1].titulo}}</span>
                <p>
                    {{notificações[1].conteúdo}}
                </p>
                <a href="#!" class="secondary-content"><i class="material-icons"></i></a>
            </li>
        </a>
        <a href="dinner.html" class="itemNotification">
            <li class="collection-item avatar">
                <img v-bind:src="notificações[2].img" class="circle">
                <span class="title">{{notificações[2].titulo}}</span>
                <p>
                    {{notificações[2].conteúdo}}
                </p>
                <a href="#!" class="secondary-content"><i class="material-icons"></i></a>
            </li>
        </a>
...
Vue.component('cmp-desc', {
    template: `
    <div class="row">
            <div class="col s12 m7">
                <div class="card">
                    <div class="card-image">
                        <img src="https://blog.novasafra.com.br/wp-content/uploads/2018/03/comida-arabe-780x450.jpg">
                    </div>
                    <div class="card-content">
                        <h1 id="itemDesc" v-text="t1"></h1>
                        <p v-text="texto"></p>
                    </div>
                    <div class="card-content">
                        <h1 id="itemDesc" v-text="t2"></h1>
                        <table class="centered" class="highlight">
                            <thead>
                                <tr>
                                    <th v-text="t3"></th>
                                    <th></th>
                            ...
                            <tbody>
                                <tr v-for="valor in tabelaNutricional">
    ...
    data() {
        return {
            ...
            tabelaNutricional: [{
                    elemento: 'Valor Energético'
                },
                {
                    elemento: 'Carboidrato'
                },
                {
                    elemento: 'Proteínas'
                },
            ...
            t1: 'Descrição',
            t2: 'Informações Nutricional',
            t3: 'Quantidade por Porção',
            texto: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut id delectus, autem deleniti unde voluptatibus quis velit, similique veniam accusamus, fuga esse magni laboriosam officia saepe aperiam debitis totam quos!',
        }
    }
});
